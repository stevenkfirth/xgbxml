...
class gbElement(etree.ElementBase):
    ...
    def get_attribute(self,attribute_name):
        ...
        # xsd_type=gbxml_functions.get_xsd_type_of_text_of_xsd_element(
        #     self.nntag,
        #     self.xsd_schema
        #     )
    ...
    def get_child(self,
        ...
        #     result=self.find('gbxml:%s' % child_nntag,namespaces=self.ns)        
        #     if result is None:
    ...
    def set_attribute(self,attribute_name,value):
        ...
        # #xsd_type=get_text_type_of_xsd_element(attribute_name,
        # #                                      xsd_schema)
        # #python_type=xsd_type_to_python_type(xsd_type)
